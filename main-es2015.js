...
let EmailValidatorComponent = class EmailValidatorComponent {
    ...
    verifyEmail() {
        ...
        this.serviceProvider.validateEmail(this.emailValidator.value).subscribe((res) => {
            this.response = res;
...
EmailValidatorComponent.ctorParameters = () => [
...
let NumbersFactsComponent = class NumbersFactsComponent {
    ...
    getFacts(factQuery) {
        this.showLoader = true;
        this.provider.getNumbersFacts(factQuery).subscribe((res) => {
            this.response = res;
            this.showResult = true;
            this.showLoader = false;
        });
...
NumbersFactsComponent.ctorParameters = () => [
...
let SearchPostOfficesComponent = class SearchPostOfficesComponent {
    constructor(provider) {
        this.provider = provider;
        this.showLoader = false;
        this.showResult = false;
    ...
    searchUsingPincode() {
        ...
        this.provider.searchPostOffices(requestBody).subscribe((res) => {
            this.response = res;
            this.showResult = true;
            this.showLoader = false;
        });
...
SearchPostOfficesComponent.ctorParameters = () => [
...
let SearchRailwaysStationsComponent = class SearchRailwaysStationsComponent {
    constructor(provider) {
        this.provider = provider;
        this.showLoader = false;
        this.showResult = false;
    ...
    searchStations() {
        this.showLoader = true;
        this.provider.searchRailwaysStations(this.searchField.value).subscribe((res) => {
    ...
    checkStatus() {
        this.showLoader = true;
        this.provider.pnrStatusCheck(this.pnrStatusField.value).subscribe((res) => {
            this.response = res;
            this.showResult = true;
            this.showLoader = false;
        });
...
SearchRailwaysStationsComponent.ctorParameters = () => [
...
let UrlShortenerComponent = class UrlShortenerComponent {
    constructor(provider) {
        this.provider = provider;
        this.showLoader = false;
        this.showResult = false;
...
UrlShortenerComponent.ctorParameters = () => [
...
let WeatherWidgetComponent = class WeatherWidgetComponent {
    ...
    getCurrentWeatherData() {
        this.dataProvider.currentWeatherAPI(this.latitude, this.longitude).subscribe((res) => {
            this.response = res;
        });
    }
    get5daysForecastData() {
        var index = 0, arrayIndex = [];
        this.dataProvider.weatherForcastAPI(this.latitude, this.longitude).subscribe((res) => {
...
WeatherWidgetComponent.ctorParameters = () => [
...
let WikiSynonymComponent = class WikiSynonymComponent {
    constructor(provider) {
        this.provider = provider;
        this.showLoader = false;
        this.showResult = false;
...
WikiSynonymComponent.ctorParameters = () => [
...
let WordsComponent = class WordsComponent {
    ...
    searchWordsAPI() {
        this.showLoader = true;
        this.serviceProvider.relatedWordApi(this.wordField.value, this.relatedWord).subscribe((res) => {
            this.response = res;
            this.showLoader = false;
        });
    }
...
let EmailValidationApiService = class EmailValidationApiService {
    constructor(http) {
        this.http = http;
...
EmailValidationApiService.ctorParameters = () => [
...
NumbersFactsApiService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
PinCodesApiService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let SearchStationsApiService = class SearchStationsApiService {
    constructor(http) {
        this.http = http;
    ...
    searchRailwaysStations(station) {
...
SearchStationsApiService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let UrlShortenerApiService = class UrlShortenerApiService {
    constructor(http) {
        this.http = http;
...
UrlShortenerApiService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let WikiSynonymApiService = class WikiSynonymApiService {
    constructor(http) {
        this.http = http;
...
WikiSynonymApiService.ctorParameters = () => [
...
let WordsApiService = class WordsApiService {
    constructor(http) {
        this.http = http;
        this.wordApiEndpoint = 'https://wordsapiv1.p.rapidapi.com/words/';
    }
    relatedWordApi(word, mode) {
...
WordsApiService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
